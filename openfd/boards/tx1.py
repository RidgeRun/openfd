...
#
# Definitions for the NVIDIA JETSON TX1
#
# ==========================================================================

from board import Board
from tx1_args import Tx1ArgsParser
from tx1_sd_comp import Tx1SdCompInstaller
...
class Tx1(Board):
    ...
    def sd_init_comp_installer(self, args):
        self._comp_installer = Tx1SdCompInstaller()
