...
class BootloaderInstaller:
    ...
    def install_kernel(self, device, partition_index, kernel_image):
        """
    ...
    def _check_sd_mounted(self,device,partition_index,m_point):
        ...
        if not self._dryrun:
            ...
            current_mpoint = self._sd_installer.get_mount_point(partition)
...
# ==========================================================================
    ...
    kernel_image = workdir + '/kernel.uImage'    
    if bl_installer.install_kernel(device,partition_index,kernel_image):
